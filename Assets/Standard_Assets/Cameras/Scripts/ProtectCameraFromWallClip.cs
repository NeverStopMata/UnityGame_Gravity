...
namespace UnityStandardAssets.Cameras {
    public class ProtectCameraFromWallClip : MonoBehaviour {
        ...
        public float originalDist = 20.0f; // the original distance to the camera before any modification are made
        ...
        private void LateUpdate () {
            ...
            if (initialIntersect) {
                ...
                m_Hits = Physics.RaycastAll (m_Ray, originalDist - sphereCastRadius);
            } else {
                // if there was no collision do a sphere cast to see if there were any other collisions
                m_Hits = Physics.SphereCastAll (m_Ray, sphereCastRadius, originalDist + sphereCastRadius);
            }
            ...
            m_CurrentDist = Mathf.Clamp (m_CurrentDist, closestDistance, originalDist);
